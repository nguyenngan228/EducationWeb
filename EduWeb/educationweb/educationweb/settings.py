...
# ALLOWED_HOSTS = ['127.0.0.1','61d4-113-161-38-21.ngrok-free.app', 'localhost']
ALLOWED_HOSTS = []
...
cloudinary.config(
    ...
    api_secret="76K0P0DCWrcyFop6C8jMqDIovVA",  # Click 'View Credentials' below to copy your API secret
    secure=True
)
